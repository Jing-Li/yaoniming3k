...
## 9. Code Craftsmanship Iron Rules

Constant extraction, DRY patterns, dead code detection, stdlib preference, and test craftsmanship. See [references/code-craftsmanship-rules.md](references/code-craftsmanship-rules.md) for full content (§9.1–§9.7).
