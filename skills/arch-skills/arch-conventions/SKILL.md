...
description: "Shared conventions and protocols for the arch skill pipeline. Holds canonical specs referenced by all arch-skills: kanban-spec.md (task lifecycle protocol) and ask-user-question-spec.md (structured questioning protocol). All arch-skills reference this skill for shared protocols. Trigger when user says \"/arch-conventions\", \"show kanban spec\", \"show question spec\", or asks about shared arch pipeline conventions."
version: 1.0.0
---
...
- **AskUserQuestion Protocol**: Extracted from arch-review §8.5 AD Confirmation Protocol. Generalized for all skills that use structured user questioning.
