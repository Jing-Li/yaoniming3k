...
| Domain Refresh Protocol | [references/domain-refresh-spec.md](references/domain-refresh-spec.md) | All arch-skills (domain self-evolution: search, distill, validate, propose via AD) |
...
See [domain-refresh-spec.md](../arch-conventions/references/domain-refresh-spec.md)
```
...
- **Domain Refresh Protocol**: Defines how each skill self-evolves — search domain best practices, distill execution patterns, validate against constraints, propose changes via AD. No skill silently self-modifies.
