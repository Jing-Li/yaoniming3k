...
| 005 | ProjectConfig：全局配置加载模块 | enhancement, closed | TDD 完成：3 tests GREEN，集成到 web/main.py、cli/main.py，创建 configs/project.yaml |
...
| 008 | StrategyRegistry：策略注册表 + `/api/strategies` | enhancement, closed | TDD 完成：4 tests GREEN，端点已上线 |
